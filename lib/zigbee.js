...
var ZigbeeNode = exports.ZigbeeNode = function(zbee, params, data_parser) {
	...
	var self = this;
	this.zdo.on("endpoint", function(desc) {
		self._putEndpoint(desc);
	});
...
ZigbeeNode.prototype._putEndpoint = function(endpointDesc) {
	//console.log("putting endpoint: " + endpointDesc.endpoint);
	var endpoint = new Endpoint(this, endpointDesc);
	this.endpoints[endpointDesc.endpoint] = endpoint;
}

ZigbeeNode.prototype.getEndpoint = function(id) {
...
var Endpoint = exports.Endpoint = function(node, desc) {
	...
	this.id = desc.endpoint;		// endpoint id
