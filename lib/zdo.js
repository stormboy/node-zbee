...
var ZigbeeObject = require('./zigbee-object').ZigbeeObject;
var ZDP = require("./profiles/zdp");
var HA = require("./profiles/ha");

var Tools = Zigbee.Tools;
var StatusValue = ZDP.StatusValue;
var ClusterId = ZDP.ClusterId;
...
/**
 * To send to request coordinator wh will manage the bind
 */
